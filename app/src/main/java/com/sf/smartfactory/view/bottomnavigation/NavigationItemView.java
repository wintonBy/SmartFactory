...
public class NavigationItemView extends RelativeLayout {
    ...
    private int activeIcon = R.mipmap.ic_launcher;

    private int unactiveIcon = R.mipmap.ic_launcher;
    ...
    private void initIcon(){
        RelativeLayout.LayoutParams  layoutParams = new RelativeLayout.LayoutParams(dp2px(getContext(),iconSize), dp2px(getContext(),iconSize));
        layoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL);
